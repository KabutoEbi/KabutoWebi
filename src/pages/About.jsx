        ...
        <div className="text-center bg-green-100">
            ...
            <div className="mt-4 text-xl">
                ...
                <div className="text-xl">
                    <p className="font-bold text-2xl bg-green-300 border-t-2 border-gray-400 p-4">自己紹介</p>
                    <div className="my-4">
                        <p>KabutoEbi</p>
                ...
                <div className="mt-4 text-xl">
                    <p className="font-bold text-2xl bg-green-300 border-t-2 border-gray-400 p-4">経歴</p>
                    <div className="my-4">
                        <p>2007年9月12日：誕生</p>
                        <p>2014年4月：小学校入学</p>
                        <p>2020年3月：小学校卒業</p>
                ...
                <div className="mt-4 text-xl">
                    <p className="font-bold text-2xl bg-green-300 border-t-2 border-gray-400 p-4">技術スタック</p>
