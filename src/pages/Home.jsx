    ...
    return (
        <div className="text-center bg-green-100">
            ...
            <div className="text-center mt-4">
                <p className="font-bold text-2xl bg-green-300 border-t-6 border-green-600 p-4">Products</p>
                <div className="text-xl p-4">
                    <p><a href="/products">過去の製作物→</a></p>
                </div>
            </div>
            <div className="text-center mt-4">
                <p className="font-bold text-2xl bg-green-300 border-t-6 border-green-600 p-4">About</p>
                <div className="text-xl p-4">
                    <p><a href="/about">詳しい自己紹介→</a></p>
                </div>
            </div>
            <Articles />
            <Notifications />
