    ...
    return (
        <div className="text-center">
            ...
            <div className="text-center mt-4">
                <p className="font-bold text-2xl bg-green-300 border-t-2 border-gray-400 p-4">Products</p>
                <div className="text-xl p-4">
                    <p><a href="/products" className="hover:underline">過去の製作物→</a></p>
                </div>
            </div>
            <div className="text-center mt-4">
                <p className="font-bold text-2xl bg-green-300 border-t-2 border-gray-400 p-4">About</p>
                <div className="text-xl p-4">
